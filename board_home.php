...
<body class="bg-back-color h-screen">
  ...
  include 'navbar.php';
  ?>
  <main class="container mx-auto p-0 h-full">
    <!-- user nemu -->
    <div class="h-full flex justify-center items-center">
      ...
      ?>
        <div class="flex flex-col">
          ...
          <div class="mt-10 max-w-sm w-full">
            <!-- 状況の切り替え -->
            <button id="open-modal" class="w-full border border-gray-800 bg-red-500 rounded-2xl flex flex-col justify-between leading-normal my-5">
      ...
      ?>
        <div class="flex flex-col">
          ...
          ?>
            <!-- 災害時 -->
            <div class="z-[90] max-w-sm w-full m-5 mt-10" onclick="location.href='./report.php'">
              <div class="border border-gray-800 bg-white rounded-2xl flex flex-col justify-between leading-normal">
                <div class="flex justify-end pt-2 pr-2">
                  <button id="open-modal" class="z-[100] w-12 h-12 bg-gray-700 rounded-full flex items-center justify-center">
            ...
            <div id="modal" class="mx-5 modal hidden fixed top-24 md:top-40 flex items-center justify-cente rounded-xl">
              <div class="modal-overlay absolute w-min inset-0 bg-gray-500 opacity-75 "></div>
              <div class="modal-container bg-white w-full mx-auto rounded-xl shadow-lg z-50 overflow-y-auto">
                <div class="relative modal-content py-4 px-6">
                  <div class="flex flex-col justify-between items-center pb-3">
                    <button id="close-modal" class="absolute -top-2 right-0 abstract text-black close-modal">
                      <span class="text-3xl">×</span>
                    </button>
                    <div class="flex flex-col">
                      <p class="w-full text-2xl font-bold text-center text-gray-950  mb-5 mt-3">
                        現在「<?= $env ?>」状態です
                      </p>
                      <p class="w-full text-2xl font-bold text-center flex justify-center items-center text-gray-950">安否報告ができます</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="relative modal-content py-4 px-6">
                  <div class="flex flex-col justify-between items-center pb-3">
                    ...
                    <div class="flex flex-col">
                      ...
                      <p class="w-full text-2xl font-bold text-center flex justify-center items-center text-gray-950">体調報告ができます</p>
                    </div>
                  </div>
                </div>
              </div>
